    ...
    const theme = createTheme(
        {
            ...
            palette: {
                type: mode,
                primary: { main: "#7752FE" },
                textPrimary: mode === "light" ? "#7752FE" : "#FFFFFF",
                borderPrimary: mode === "light" ? "#7752FE" : "#FFFFFF",
                dark: { main: mode === "light" ? "#333333" : "#F3F3F3" },
                light: { main: mode === "light" ? "#F3F3F3" : "#333333" },
                tabHeaderBackground: mode === "light" ? "#EEE" : "#333",
                optionsBackground: mode === "light" ? "#fafafa" : "#333",
				options: mode === "light" ? "#fafafa" : "#666",
				fontecor: mode === "light" ? "#7752FE" : "#fff",
                ...
                barraSuperior: mode === "light" ? "linear-gradient(to right, #7752FE, #7752FE, #7752FE)" : "#666",
